...
INSERT INTO `acompanantes` VALUES ('1223455678',1,'alex','rodriguez','1234567810','hermano',35),('5254565879',1,'jorge','rodriguez','1234567810','hermano',22);
...
CREATE TABLE `check_in` (
  ...
  `id_cliente` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_reserva` int DEFAULT NULL,
  `llave` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `habitacion` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dias_estancia` int DEFAULT NULL,
  `numero_acompanantes` int DEFAULT NULL,
  `servicios_adicionales` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `check_out` (
  ...
  `id_cliente` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `habitaciones` (
  ...
  `tipo_habitacion` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre_habitacion` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `historial` (
  ...
  `estado_reserva` enum('activa','eliminada','modificada','finalizada') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `historial_pagos` (
  ...
  `estado_pago` enum('Pendiente','Pagada','Cancelado') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `personas_hospedaje` (
  `id` int NOT NULL AUTO_INCREMENT,
  `documento_identidad` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `es_cliente_principal` varchar(2) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `politica_aceptada` varchar(2) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `aceptado_por_tercero` varchar(2) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `reservas` VALUES (2,'1070589457',1,'2025-09-23','2025-09-25',1600000.00,2);
...
INSERT INTO `usuarios` VALUES ('adminHotel','admin1234',1,'2025-05-10 19:32:33'),('antonio','boupojp',2,'2025-05-06 22:57:04'),('daniel','ebojfm',2,'2025-05-06 22:57:04'),('dayana','ebzbob',2,'2025-05-06 22:57:04'),('dayis','ebzjt',2,'2025-09-28 22:45:01'),('esteban','ftufcbo',2,'2025-05-06 22:57:04'),('jose','kptf',2,'2025-05-06 22:57:04'),('jrambo','ksbncp',2,'2025-05-06 22:57:04'),('juan','kvbo',2,'2025-05-06 22:57:04'),('nikolay','ojlpmbz',2,'2025-05-29 14:30:22'),('pablo','qbcmp',2,'2025-05-06 22:57:04'),('paola','qbpmb',2,'2025-05-06 22:57:04'),('paula','qbvmb',2,'2025-05-06 22:57:04'),('pilar','qjmbs',2,'2025-05-07 00:43:55'),('samuel','tbnvfm',2,'2025-05-06 22:57:04'),('sandra','tboesb',2,'2025-05-06 22:57:04');
...
-- Dump completed on 2025-09-28 19:16:08
